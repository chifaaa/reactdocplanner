...
<main>
    <div className="logo-center" style={{marginTop: '55px'}}>
            <img src={img} alt="Docplanner"/>
            <h1 style={{fontFamily: 'Helvetica Neue',FontSize: '34px', fontWeight: '300',color: 'rgb(0, 179, 155)'}}>
            Making the healthcare experience more human
            </h1>
    </div>

  <div className="inner-section-paragraphs">
                    <p style={{width: "470px"}}>We want patients to find the perfect doctor and book an appointment in the
                        most
                        easy
                    ...
                    <p style={{width: "470px"}}>We also help doctors to better manage their practice and build their online
                        reputation. With our integrated end-to-end solution, doctors are able not only to improve their
                        online
                        presence, but also to devote their time to what really matters: their patients.</p>
                </div>  
    <div className='service-cards' style={{display:'flex'}}>
  <ServiceCard service={exampleProps} />
    <ServiceCard service={{
    ...
    <div className='thesvgs' style={{display:'flex',justifyContent:'space-between'}}>
                        <h2 style={{fontFamily: 'Helvetica Neue',width:'300px', fontWeight: '300',color: 'rgb(0, 179, 155)'}}>
                            We are a global company<br/> with local culture
                        </h2>
                    
                    <div style={{display:'flex',flexWrap:'wrap',justifyContent:'space-between',alignItems:'center'}}>
                        <svg className='svg' xmlns="http://www.w3.org/2000/svg" width="200" height="32" viewBox="0 0 200 32"
                            style={{height:"25px" ,width:"128px", marginRight: "25px"}}>
                            <path
                        ...
                        <svg className='svg' xmlns="http://www.w3.org/2000/svg" width="150" height="32" viewBox="0 0 167 32"
                            style={{height:"25px" ,width:"120px", marginRight: "25px"}}>
                            <path
                        ...
                        <svg className='svg' xmlns="http://www.w3.org/2000/svg" width="182" height="32" viewBox="0 0 182 32"
                            style={{height:"25px" ,width:"128px", marginRight: "25px"}}>
                            <path
                        ...
                        <svg className='svg' xmlns="http://www.w3.org/2000/svg" width="220" height="32" viewBox="0 0 220 32"
                        ...
                        <svg className='svg' xmlns="http://www.w3.org/2000/svg" width="195" height="32" viewBox="0 0 195 32"
                            style={{height:"30px" ,width:"134px", marginRight: "25px"}}>
                            <path
                ...
                <div style={{width:'700px'}}>
                  <br/><br/>
                <h1 style={{marginLeft: '200px',fontFamily: 'Helvetica Neue',FontSize: '34px', fontWeight: '300',color: 'rgb(0, 179, 155)'}}>The world's <br/>biggest healthcare platform
                </h1>
                <p style={{marginLeft: '200px',fontFamily: 'Helvetica Neue',FontSize: '14px',color: 'rgb(116, 116, 116)'}}>We work from 6 offices all over the world, bringing Docplanner Group to
                    life in almost 20 countries.<br/><br/><br/><br/>
                </p>

                <img src={logo} style={{marginLeft: '100px'}}/>
                </div>
      <div className='featureCards' style={{display:'flex',flexWrap:'wrap',width:'500px',marginLeft:'100px'}}>
      <FeatureCard
    ...
    <div className="last-section-paragraphs-container">
            <div style={{textAlign: 'center', position: 'relative', top: '50px'}}>
                <h1 style={{fontFamily: 'Helvetica Neue',FontSize: '34px', fontWeight: '300',color: 'rgb(0, 179, 155)'}}>
                    Improve the lives of millions.<br/> Change yours forever
                </h1>
                <p style={{FontFamily:'Helvetica Neue',FontSize: '14px',color: 'rgb(116, 116, 116)'}}>
                    More than 1000 team mates share our same vision, goals and passion.<br/> With offices in Warsaw,
                    Barcelona,
        ...
        <br/><br/><br/>
<PostCard postcardprop={postCards}/>
...
<footer>
    <p>
        ...
        <span className="country-link"> Poland</span>, 
        <span className="country-link">Turkey</span>, 
        <span className="country-link">Spain</span>, 
        <span className="country-link">Italy</span>, 
        <span className="country-link">Czech Republic</span>, 
        <span className="country-link">Mexico</span>, 
        <span className="country-link">Colombia</span>, 
        <span className="country-link">Brazil</span>, 
        <span className="country-link">Argentina</span> and 
        <span className="country-link">Chile</span> <br/><br/>
